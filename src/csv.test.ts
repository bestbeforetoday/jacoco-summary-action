...
function row(...elements: (string | number)[]): string {
...
describe('csv', () => {
    describe('summary', () => {
        ...
        const testCases: { [name: string]: { extract: (c: Coverage) => number; expected: number } } = {
            instructions: {
        ...
        Object.entries(testCases).map(([name, test]) => {
    ...
    describe('packages', () => {
        ...
        const testCases: {
            [name: string]: { extract: (p: Package) => string | number; expected: (string | number)[] };
        } = {
    ...
    describe('classes', () => {
        ...
        const testCases: { [name: string]: { extract: (c: Class) => string | number; expected: (string | number)[] } } =
            {
